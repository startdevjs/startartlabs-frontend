...
const ModalCreateTopic = ({ isOpen, onClose, id }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <ModalContent>
          <Container>
          <h1> Criar tópico relacionado a este desafio <Separator/></h1>
          <form onSubmit={handleSubmit}>
            ...
            <Input text="Link do seu repositório" placeholder="Ex: Github" value={link} onChange={(e) => setLink(e.target.value)}/>
          <ContainerButtons>
